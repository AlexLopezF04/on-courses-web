...
import { GraduationCap, Mail, BookOpen, Compass, Award, Users, Info, Mailbox, Database, Code, Terminal, GitBranch } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 text-slate-400 dark:text-slate-505 mt-2">
