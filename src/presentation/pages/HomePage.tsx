  ...
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden bg-slate-950 text-white mb-16 border-b-2 border-slate-900">
        {/* Grid background */}
        <div className="absolute inset-0 bg-[linear-gradient(rgba(139,92,246,0.07)_1px,transparent_1px),linear-gradient(90deg,rgba(139,92,246,0.07)_1px,transparent_1px)] bg-[size:40px_40px]" />
        {/* Glow */}
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="hidden lg:block flex-1 max-w-lg w-full">
              <div className="border-2 border-slate-700 shadow-[8px_8px_0px_0px_rgba(139,92,246,0.3)] bg-slate-900">
                {/* window chrome */}
