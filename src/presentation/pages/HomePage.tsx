  ...
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden bg-slate-950 text-white mb-16 border-b-2 border-slate-900">
        ...
        <div className="animate-grid transition-none absolute inset-0 bg-[linear-gradient(rgba(139,92,246,0.07)_1px,transparent_1px),linear-gradient(90deg,rgba(139,92,246,0.07)_1px,transparent_1px)] bg-[size:40px_40px]" />
        {/* Glow */}
