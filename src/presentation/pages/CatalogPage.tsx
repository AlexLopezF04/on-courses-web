          ...
          {isLoading ? (
            ...
            <div>
              {courses.length > 0 ? (
                ...
                <div className="text-center py-16 bg-white dark:bg-slate-900 border border-dashed border-slate-350 dark:border-slate-800 rounded-2xl">
                  <BookOpen className="h-12 w-12 text-slate-300 mx-auto mb-4" />
                  <h3 className="text-lg font-semibold text-slate-700 dark:text-slate-300">No se encontraron cursos</h3>
                  <p className="text-sm text-slate-500 dark:text-slate-455 mt-1">Prueba a ajustar los criterios de búsqueda o filtros.</p>
                </div>
              )}
            </div>
          )}
